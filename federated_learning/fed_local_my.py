...
def get_fed_local_vlm_sft_trainer(script_args, fed_args, model, tokenizer, training_args, local_dataset, eval_dataset, compute_metrics, data_collator, global_dict, local_auxiliary, global_auxiliary,preprocess_logits_for_metrics):
...
def get_local_vlm_sft_trainer(script_args, fed_args, model, tokenizer, training_args, local_dataset, eval_dataset, compute_metrics, data_collator,preprocess_logits_for_metrics):
...
class VLMTrainer(Trainer):
    def __init__(self, model, tokenizer,args,train_dataset, eval_dataset,compute_metrics,data_collator,preprocess_logits_for_metrics):
